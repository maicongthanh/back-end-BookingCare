...
module.exports = (sequelize, DataTypes) => {
    class Doctor_Infor extends Model {
        ...
        static associate(models) {
            ...
            Doctor_Infor.belongsTo(models.Clinic, { foreignKey: 'clinicId', as: 'clinicTypeData' })
            Doctor_Infor.belongsTo(models.Specialty, { foreignKey: 'specialtyId', as: 'specialtyTypeData' })
        }
    };
